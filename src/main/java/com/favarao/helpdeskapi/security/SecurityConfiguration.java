...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http.csrf(csrf -> csrf.disable())
                ...
                .requestMatchers(HttpMethod.POST, PathAuthConstant.BASE_PATH_AUTH_LOGIN).permitAll()
                .requestMatchers(HttpMethod.POST, PathAuthConstant.BASE_PATH_AUTH_SUBSCRIBE).permitAll()
